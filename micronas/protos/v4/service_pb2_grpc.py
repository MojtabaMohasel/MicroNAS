...
from micronas.protos.v4 import (
...
def add_OracleServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "micronas.Oracle", rpc_method_handlers
    )

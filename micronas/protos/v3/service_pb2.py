...
from micronas.protos.v3 import (
    micronas_pb2 as keras__tuner_dot_protos_dot_keras__tuner__pb2,
)


DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    b'\n keras_tuner/protos/service.proto\x12\x0bkeras_tuner\x1a$keras_tuner/protos/micronas.proto"\x11\n\x0fGetSpaceRequest"I\n\x10GetSpaceResponse\x12\x35\n\x0fhyperparameters\x18\x01 \x01(\x0b\x32\x1c.micronas.HyperParameters"K\n\x12UpdateSpaceRequest\x12\x35\n\x0fhyperparameters\x18\x01 \x01(\x0b\x32\x1c.micronas.HyperParameters"\x15\n\x13UpdateSpaceResponse"&\n\x12\x43reateTrialRequest\x12\x10\n\x08tuner_id\x18\x01 \x01(\t"8\n\x13\x43reateTrialResponse\x12!\n\x05trial\x18\x01 \x01(\x0b\x32\x12.micronas.Trial"\xa3\x01\n\x12UpdateTrialRequest\x12\x10\n\x08trial_id\x18\x01 \x01(\t\x12=\n\x07metrics\x18\x02 \x03(\x0b\x32,.micronas.UpdateTrialRequest.MetricsEntry\x12\x0c\n\x04step\x18\x03 \x01(\x03\x1a.\n\x0cMetricsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\x01:\x02\x38\x01"8\n\x13UpdateTrialResponse\x12!\n\x05trial\x18\x01 \x01(\x0b\x32\x12.micronas.Trial"4\n\x0f\x45ndTrialRequest\x12!\n\x05trial\x18\x01 \x01(\x0b\x32\x12.micronas.Trial"\x12\n\x10\x45ndTrialResponse"*\n\x14GetBestTrialsRequest\x12\x12\n\nnum_trials\x18\x01 \x01(\x03";\n\x15GetBestTrialsResponse\x12"\n\x06trials\x18\x01 \x03(\x0b\x32\x12.micronas.Trial"#\n\x0fGetTrialRequest\x12\x10\n\x08trial_id\x18\x01 \x01(\t"5\n\x10GetTrialResponse\x12!\n\x05trial\x18\x01 \x01(\x0b\x32\x12.micronas.Trial2\xbf\x04\n\x06Oracle\x12I\n\x08GetSpace\x12\x1c.micronas.GetSpaceRequest\x1a\x1d.micronas.GetSpaceResponse"\x00\x12R\n\x0bUpdateSpace\x12\x1f.micronas.UpdateSpaceRequest\x1a .micronas.UpdateSpaceResponse"\x00\x12R\n\x0b\x43reateTrial\x12\x1f.micronas.CreateTrialRequest\x1a .micronas.CreateTrialResponse"\x00\x12R\n\x0bUpdateTrial\x12\x1f.micronas.UpdateTrialRequest\x1a .micronas.UpdateTrialResponse"\x00\x12I\n\x08\x45ndTrial\x12\x1c.micronas.EndTrialRequest\x1a\x1d.micronas.EndTrialResponse"\x00\x12X\n\rGetBestTrials\x12!.micronas.GetBestTrialsRequest\x1a".micronas.GetBestTrialsResponse"\x00\x12I\n\x08GetTrial\x12\x1c.micronas.GetTrialRequest\x1a\x1d.micronas.GetTrialResponse"\x00\x62\x06proto3'
)
...
GetSpaceRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetSpaceRequest)
    },
)
...
GetSpaceResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetSpaceResponse)
    },
)
...
UpdateSpaceRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.UpdateSpaceRequest)
    },
)
...
UpdateSpaceResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.UpdateSpaceResponse)
    },
)
...
CreateTrialRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.CreateTrialRequest)
    },
)
...
CreateTrialResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.CreateTrialResponse)
    },
)
    ...
    (_message.Message,),
    {
        "MetricsEntry": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "micronas.protos.service_pb2",
                # @@protoc_insertion_point(class_scope:micronas.UpdateTrialRequest.MetricsEntry)
            },
        ),
        "DESCRIPTOR": _UPDATETRIALREQUEST,
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.UpdateTrialRequest)
    },
)
...
UpdateTrialResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.UpdateTrialResponse)
    },
)
...
EndTrialRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.EndTrialRequest)
    },
)
...
EndTrialResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.EndTrialResponse)
    },
)
...
GetBestTrialsRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetBestTrialsRequest)
    },
)
...
GetBestTrialsResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetBestTrialsResponse)
    },
)
...
GetTrialRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetTrialRequest)
    },
)
...
GetTrialResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "micronas.protos.service_pb2",
        # @@protoc_insertion_point(class_scope:micronas.GetTrialResponse)
    },
)

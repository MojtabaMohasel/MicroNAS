...
import keras_tuner
from micronas.engine import objective
...
def test_create_objective_with_objective():
    obj = objective.create_objective("accuracy")
    obj = objective.create_objective(micronas.Objective("score", "min"))
...
def test_create_objective_with_multi_objective():
    obj = objective.create_objective(
        [
            micronas.Objective("score", "max"),
            micronas.Objective("loss", "min"),
        ]
    )

...
from micronas import config as config_module
from micronas import errors
from micronas import utils
from micronas.api_export import keras_tuner_export
from micronas.distribute import utils as dist_utils
from micronas.engine import hypermodel as hm_module
from micronas.engine import oracle as oracle_module
...
@keras_tuner_export(["micronas.engine.base_tuner.BaseTuner"])
class BaseTuner(stateful.Stateful):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if dist_utils.has_chief_oracle() and not dist_utils.is_chief_oracle():
            ...
            from micronas.distribute import oracle_client
    ...
    def search(self, *fit_args, **fit_kwargs):
        ...
        if dist_utils.is_chief_oracle():
            ...
            # Avoid import at the top, to avoid inconsistent protobuf versions.
            from micronas.distribute import oracle_chief

...
@keras_tuner_export(["micronas.errors.FailedTrialError"])
    ...
    class MyHyperModel(micronas.HyperModel):
        def build(self, hp):
            ...
            if too_slow(model):
                ...
                raise micronas.FailedTrialError("Model is too slow.")
            return model
    ```
    """
...
@keras_tuner_export(["micronas.errors.FatalError"])
...
@keras_tuner_export(["micronas.errors.FatalValueError"])
...
@keras_tuner_export(["micronas.errors.FatalTypeError"])
...
@keras_tuner_export(["micronas.errors.FatalRuntimeError"])

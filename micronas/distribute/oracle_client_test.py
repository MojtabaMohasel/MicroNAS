...
from micronas.test_utils import mock_distribute
from micronas.tuners import randomsearch


class SimpleTuner(micronas.engine.base_tuner.BaseTuner):
...
def test_base_tuner_distribution(tmp_path):
    ...
    def _test_base_tuner():
        ...
        tuner = SimpleTuner(
            oracle=micronas.oracles.RandomSearchOracle(
                objective=micronas.Objective("score", "max"), max_trials=10
            ),
...
@mock.patch("micronas.distribute.oracle_client.OracleClient.get_space")
